...
const KakaoStrategy = require('passport-kakao').Strategy; // passport=lalap 모듈에서 KakaoStrategy 불러오기
...
module.exports = () => { // 모듈을 내보내는 함수
    ...
    }, async (accessToken, refreshToken, profile, done) => { // LalapStrategy 인증 콜백 함수
